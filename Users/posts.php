...
echo "<link href='/style.css' rel='stylesheet' type='text/css'/><img src='" . $index['users'][$user]['pfp'] . "' width='100' class='profile' height=auto/>" . $index['users'][$user]['user-name'] . "<br><button onclick='location=\"/Users/follow.php?user=" . $index['users'][$user]['user-id'] . "\"'>Follow</button><br>";
